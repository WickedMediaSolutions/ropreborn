...
const struct clan_type clan_table[MAX_CLAN] = {
    ...
    {"clan3", "[ Clan3 ] ", ROOM_VNUM_ALTAR, TRUE},
    {"clan4", "[ Clan4 ] ", ROOM_VNUM_ALTAR, TRUE},
    {"clan5", "[ Clan5 ] ", ROOM_VNUM_ALTAR, TRUE},
    {"clan6", "[ Clan6 ] ", ROOM_VNUM_ALTAR, TRUE},
    {"clan7", "[ Clan7 ] ", ROOM_VNUM_ALTAR, TRUE}
};
