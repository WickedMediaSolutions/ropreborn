...
CHAR_DATA *new_char (void)
{
    ...
    *ch = ch_zero;
    ...
    /* ROP Initialization - Core fields */
    ch->sect_number = 0;                    /* Unassigned sect */
    ch->warpoint = 0;                       /* No warpoints on creation */
    ch->profession_rank = 0;                /* No profession rank */
    ch->remort_count = 0;                   /* No remorts yet */
    ch->remort_benefits_applied = FALSE;    /* Remort benefits not applied */
    ch->remort_hp_bonus = 0;                /* No HP bonus yet */
    ch->remort_move_bonus = 0;              /* No move bonus yet */
