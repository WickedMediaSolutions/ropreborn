...
DECLARE_DO_FUN( do_warpoint		);
DECLARE_DO_FUN( do_warpoint_set		);
DECLARE_DO_FUN( do_warpoint_show	);
DECLARE_DO_FUN( do_warpoint_strip	);
DECLARE_DO_FUN( do_rank			);
DECLARE_DO_FUN( do_sect			);
DECLARE_DO_FUN( do_sect_set		);
DECLARE_DO_FUN( do_sect_alignment	);
DECLARE_DO_FUN( do_sectalk		);
DECLARE_DO_FUN( do_sectell		);
