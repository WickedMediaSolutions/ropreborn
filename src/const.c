...
*/
    ...
    /* ROP: Additional 19 races to reach 24 total */
    {
     ...
     {"",}, 
     {13, 14, 12, 14, 12}, {18, 19, 17, 19, 17}, SIZE_MEDIUM},

    {
     "feline", "Feli", 2, {100, 100, 100, 125},
     {"sneak"},
     {12, 12, 12, 15, 12}, {17, 17, 17, 21, 17}, SIZE_SMALL},

    {
     "lizard", "Liza", 4, {120, 110, 115, 100},
     {""},
     {14, 12, 13, 12, 14}, {19, 17, 18, 17, 19}, SIZE_MEDIUM},

    {
     "dragon", "Drag", 10, {150, 140, 140, 120},
     {"bash"},
     {15, 13, 13, 12, 15}, {21, 18, 18, 17, 21}, SIZE_LARGE},

    {
     "undead", "Unde", 5, {110, 120, 100, 110},
     {""},
     {13, 14, 11, 13, 10}, {18, 19, 16, 18, 15}, SIZE_MEDIUM},

    {
     "orc", "Orc ", 3, {110, 100, 105, 100},
     {"bash"},
     {14, 10, 11, 11, 14}, {19, 15, 16, 16, 19}, SIZE_MEDIUM},

    {
     "goblin", "Gobl", 1, {100, 105, 100, 120},
     {"sneak"},
     {11, 12, 11, 14, 10}, {16, 17, 16, 19, 15}, SIZE_SMALL},

    {
     "gnome", "Gnom", 2, {105, 110, 105, 110},
     {"sneak", "hide"},
     {12, 13, 12, 14, 12}, {17, 18, 17, 19, 17}, SIZE_SMALL},

    {
     "halfling", "Half", 2, {100, 110, 105, 115},
     {"sneak", "hide"},
     {11, 13, 12, 15, 12}, {16, 18, 17, 20, 17}, SIZE_SMALL},

    {
     "troll", "Trol", 6, {140, 110, 110, 100},
     {"bash", "fast healing"},
     {15, 10, 11, 10, 15}, {20, 15, 16, 15, 20}, SIZE_LARGE},

    {
     "minotaur", "Mino", 5, {130, 100, 110, 95},
     {"bash"},
     {15, 10, 12, 10, 14}, {20, 15, 17, 15, 19}, SIZE_LARGE},

    {
     "centaur", "Cent", 5, {120, 100, 110, 110},
     {"bash"},
     {14, 11, 12, 13, 13}, {19, 16, 17, 18, 18}, SIZE_LARGE},

    {
     "faerie", "Faer", 4, {100, 125, 120, 115},
     {"sneak", "hide"},
     {11, 14, 14, 15, 11}, {16, 19, 19, 20, 16}, SIZE_SMALL},

    {
     "drow", "Drow", 6, {100, 130, 110, 120},
     {"sneak", "hide"},
     {12, 15, 12, 15, 11}, {17, 20, 17, 20, 16}, SIZE_SMALL},

    {
     "aarakocra", "Aara", 3, {100, 110, 110, 120},
     {"sneak"},
     {12, 13, 13, 15, 11}, {17, 18, 18, 20, 16}, SIZE_SMALL},

    {
     "naga", "Naga", 5, {120, 115, 110, 110},
     {"sneak"},
     {13, 14, 12, 13, 14}, {18, 19, 17, 18, 19}, SIZE_MEDIUM},

    {
     "kender", "Kend", 1, {100, 110, 105, 115},
     {"sneak", "hide"},
    ...
    {
     "changeling", "Chan", 7, {110, 115, 115, 115},
     {"sneak", "hide"},
     {13, 14, 14, 14, 12}, {18, 19, 19, 19, 17}, SIZE_MEDIUM},

    {
     "void-touched", "Void", 8, {100, 130, 120, 115},
     {"hide"},
...
char *const title_table[MAX_CLASS][MAX_LEVEL + 1][2] = {
    ...
    /* Ranger Class (Class 4) */
    {
     ...
     {"Scout", "Scout"},
     {"Ranger Novice", "Ranger Novice"},
     {"Wilderness Guide", "Wilderness Guide"},

     {"Ranger", "Ranger"},
     {"Seasoned Ranger", "Seasoned Ranger"},
     {"Ranger Knight", "Ranger Knight"},
     {"Beast Master", "Beast Mistress"},
     {"Ranger Captain", "Ranger Captain"},

     {"Ranger Commander", "Ranger Commander"},
     {"Forest Lord", "Forest Lady"},
     {"Master of Beasts", "Mistress of Beasts"},
     {"Archer Supreme", "Archer Supreme"},
     {"Ranger Expert", "Ranger Expert"},

     {"Ranger Specialist", "Ranger Specialist"},
     {"Ranger Champion", "Ranger Champion"},
     {"Ranger Legend", "Ranger Legend"},
     {"Ranger Sage", "Ranger Sage"},
     {"Ranger Master", "Ranger Master"},

     {"Grand Ranger", "Grand Ranger"},
     {"Greater Ranger", "Greater Ranger"},
     {"Superior Ranger", "Superior Ranger"},
     {"Legendary Ranger", "Legendary Ranger"},
     {"Ranger Titan", "Ranger Titan"},

     {"Ranger Juggernaut", "Ranger Juggernaut"},
     {"Ranger Colossus", "Ranger Colossus"},
     {"Wilderness King", "Wilderness Queen"},
     {"Guardian of Nature", "Guardian of Nature"},
     {"Master of Wilderness", "Mistress of Wilderness"},

     {"Ranger Immortal", "Ranger Immortal"},
     {"Ranger Avatar", "Ranger Avatar"},
     {"Ranger Deity", "Ranger Deity"},
     {"Ranger Supreme", "Ranger Supreme"},
     {"Ranger Ascendant", "Ranger Ascendant"},
     ...
     {"Avatar of the Wild", "Avatar of the Wild"},
     {"Angel of the Forest", "Angel of the Forest"},
     {"Demigod of Rangers", "Demigoddess of Rangers"},
     {"Immortal Ranger", "Immortal Ranger"},
     {"God of Rangers", "Goddess of Rangers"},
     {"Deity of Rangers", "Deity of Rangers"},
     {"Supreme Master of Rangers", "Supreme Mistress of Rangers"},
     {"Creator", "Creator"},
     {"Implementor", "Implementress"}
     },

    /* Paladin Class (Class 5) */
    {
     {"Man", "Woman"},

     {"Believer", "Believer"},
     {"Holy Aspirant", "Holy Aspirant"},
     {"Righteous One", "Righteous One"},
     {"Paladin Novice", "Paladin Novice"},
     {"Holy Knight", "Holy Knight"},

     {"Sacred Knight", "Sacred Knight"},
     {"Righteous Knight", "Righteous Knight"},
     ...
     {"Paladin War Master", "Paladin War Master"},
     {"Knight Templar", "Knight Templar"},

     {"Grand Templar", "Grand Templar"},
     {"Sentinel of Light", "Sentinel of Light"},
     {"Guardian of Innocence", "Guardian of Innocence"},
     {"Keeper of the Faith", "Keeper of the Faith"},
     {"Holy Avenger", "Holy Avenger"},

     {"Righteous Avenger", "Righteous Avenger"},
     {"Divine Wrath", "Divine Wrath"},
     {"Holy Terror", "Holy Terror"},
     {"Instrument of Justice", "Instrument of Justice"},
     {"Divine Judge", "Divine Judge"},

     {"Arbiter of Light", "Arbiter of Light"},
     {"Holy Magistrate", "Holy Magistrate"},
     {"Divine Magistrate", "Divine Magistrate"},
     {"Hammer of Justice", "Hammer of Justice"},
     {"Sword of Righteousness", "Sword of Righteousness"},

     {"Paladin Lord", "Paladin Lord"},
     {"Paladin Duke", "Paladin Duke"},
     {"Paladin Prince", "Paladin Prince"},
     {"Paladin King", "Paladin Queen"},
     {"Paladin Emperor", "Paladin Empress"},
     ...
     {"Demigod of Paladins", "Demigoddess of Paladins"},
     {"Immortal Paladin", "Immortal Paladin"},
     {"God of Justice", "Goddess of Justice"},
     {"Deity of Righteousness", "Deity of Righteousness"},
     {"Supreme Master of Light", "Supreme Mistress of Light"},
     {"Creator", "Creator"},
     {"Implementor", "Implementress"}
     },
    ...
    /* Druid Class (Class 6) */
    {
     ...
     {"Nature Child", "Nature Child"},
     {"Druid Novice", "Druid Novice"},
     {"Apprentice of Nature", "Apprentice of Nature"},
     {"Student of Herbs", "Student of Herbs"},
     {"Nature Warden", "Nature Warden"},

     {"Herb Master", "Herb Master"},
     {"Beast Friend", "Beast Friend"},
     {"Nature Priest", "Nature Priestess"},
     {"Druid Keeper", "Druid Keeper"},
     {"Guardian of Animals", "Guardian of Animals"},

     {"Master of Balance", "Master of Balance"},
     {"Circle Druid", "Circle Druid"},
     {"Druid Adept", "Druid Adept"},
     {"Shaman of Nature", "Shaman of Nature"},
     {"Elemental Druid", "Elemental Druid"},

     {"Druid Sage", "Druid Sage"},
     {"Master Druid", "Master Druid"},
     {"Nature Speaker", "Nature Speaker"},
     {"Keeper of Time", "Keeper of Time"},
     {"Warden of Life", "Warden of Life"},

     {"Druid Knight", "Druid Knight"},
     {"Druid Champion", "Druid Champion"},
     {"Nature Champion", "Nature Champion"},
     {"Primordial Guardian", "Primordial Guardian"},
     {"Ancient One", "Ancient One"},

     {"Forest Ancient", "Forest Ancient"},
     {"Spirit Speaker", "Spirit Speaker"},
     {"Elemental Master", "Elemental Master"},
     {"Nature Lord", "Nature Lady"},
     {"Keeper of the Green", "Keeper of the Green"},

     {"Druid Immortal", "Druid Immortal"},
     {"Nature Avatar", "Nature Avatar"},
     {"Primal Force", "Primal Force"},
     {"Druid Supreme", "Druid Supreme"},
     ...
     {"Angel of Earth", "Angel of Earth"},
     {"Demigod of Druids", "Demigoddess of Druids"},
     {"Immortal Druid", "Immortal Druid"},
     {"God of Nature", "Goddess of Nature"},
     {"Deity of Life", "Deity of Life"},
     {"Supreme Master of the Wilds", "Supreme Mistress of the Wilds"},
     {"Creator", "Creator"},
     {"Implementor", "Implementress"}
     },
    ...
    /* Bard Class (Class 7) */
    {
     ...
     {"Bard Novice", "Bard Novice"},
     {"Songsmith", "Songsmith"},
     {"Minstrel", "Minstrel"},
     {"Bard Apprentice", "Bard Apprentice"},

     {"Seasoned Bard", "Seasoned Bard"},
     {"Traveling Bard", "Traveling Bard"},
     {"Master Performer", "Mistress Performer"},
     {"Bard Virtuoso", "Bard Virtuoso"},
     {"Song Weaver", "Song Weaver"},

     {"Lore Master", "Lore Master"},
     {"Bard Enchanter", "Bard Enchanter"},
     {"Master of Tales", "Mistress of Tales"},
     {"Legend Teller", "Legend Teller"},
     {"Bard Expert", "Bard Expert"},

     {"Bard Sage", "Bard Sage"},
     {"Bard Scholar", "Bard Scholar"},
     {"Story Lord", "Story Lady"},
     {"Wizard of Words", "Wizard of Words"},
     {"Master of Arts", "Mistress of Arts"},

     {"Bard Champion", "Bard Champion"},
     {"Song Champion", "Song Champion"},
     {"Legendary Performer", "Legendary Performer"},
     {"Bard of Renown", "Bard of Renown"},
     {"Keeper of Songs", "Keeper of Songs"},

     {"Master of Magic", "Mistress of Magic"},
     {"Grand Bard", "Grand Bard"},
     {"Supreme Performer", "Supreme Performer"},
     {"Bard King", "Bard Queen"},
     {"Bard Lord", "Bard Lord"},

     {"Bard Immortal", "Bard Immortal"},
     {"Bard Avatar", "Bard Avatar"},
     {"Living Legend", "Living Legend"},
     {"Bard Ascendant", "Bard Ascendant"},
     {"Bard Supreme", "Bard Supreme"},
     ...
     {"Avatar of Song", "Avatar of Song"},
     {"Angel of Music", "Angel of Music"},
     {"Demigod of Bards", "Demigoddess of Bards"},
     {"Immortal Bard", "Immortal Bard"},
     {"God of Music", "Goddess of Music"},
     {"Deity of Song", "Deity of Song"},
     {"Supreme Master of Arts", "Supreme Mistress of Arts"},
     {"Creator", "Creator"},
     {"Implementor", "Implementress"}
     },

    /* Assassin Class (Class 8) */
    {
     {"Man", "Woman"},

     {"Dark Initiate", "Dark Initiate"},
     {"Assassin Novice", "Assassin Novice"},
     {"Silent One", "Silent One"},
     {"Shadow Apprentice", "Shadow Apprentice"},
     ...
     {"Shade Walker", "Shade Walker"},
     {"Blackened Soul", "Blackened Soul"},
     {"Death Dealer", "Death Dealer"},
     {"Assassin Lord", "Assassin Lord"},
     {"Master of Shadows", "Mistress of Shadows"},

     {"Dark Master", "Dark Master"},
     {"Shadow Master Elite", "Shadow Master Elite"},
     {"Eternal Night", "Eternal Night"},
     {"Death's Servant", "Death's Servant"},
     {"Harbinger of Death", "Harbinger of Death"},

     {"Arch Assassin", "Arch Assassin"},
     {"Grand Assassin", "Grand Assassin"},
     {"Supreme Assassin", "Supreme Assassin"},
     {"Assassin Judge", "Assassin Judge"},
     {"Shadow King", "Shadow Queen"},

     {"Assassin Immortal", "Assassin Immortal"},
     {"Assassin Avatar", "Assassin Avatar"},
     {"Assassin Deity", "Assassin Deity"},
     {"Assassin Supreme", "Assassin Supreme"},
     {"Shadow Ascendant", "Shadow Ascendant"},
     ...
     {"Assassin Hero", "Assassin Heroine"},
     {"Avatar of Death", "Avatar of Death"},
     {"Angel of Vengeance", "Angel of Vengeance"},
     {"Demigod of Assassins", "Demigoddess of Assassins"},
     {"Immortal Assassin", "Immortal Assassin"},
     {"God of Assassins", "Goddess of Assassins"},
     {"Deity of Shadows", "Deity of Shadows"},
     {"Supreme Master of Shadows", "Supreme Mistress of Shadows"},
     {"Creator", "Creator"},
     {"Implementor", "Implementress"}
     },

    /* Blackguard Class (Class 9) */
    {
     {"Man", "Woman"},

     {"Dark Knight", "Dark Knight"},
     {"Blackguard Novice", "Blackguard Novice"},
     {"Evil Aspirant", "Evil Aspirant"},
     {"Shadow Knight", "Shadow Knight"},
     {"Fell Knight", "Fell Knight"},

     {"Corrupt Knight", "Corrupt Knight"},
     {"Black Warrior", "Black Warrior"},
     {"Sinister Warrior", "Sinister Warrior"},
     {"Evil Champion", "Evil Champion"},
     {"Blackened Warrior", "Blackened Warrior"},

     {"Dark Knight Master", "Dark Knight Master"},
     {"Blackened Master", "Blackened Master"},
     {"Evil Master", "Evil Master"},
     {"Shadow Warrior", "Shadow Warrior"},
     {"Dread Knight", "Dread Knight"},

     {"Dread Master", "Dread Master"},
     {"Death Knight", "Death Knight"},
     {"Instrument of Evil", "Instrument of Evil"},
     {"Harbinger of Darkness", "Harbinger of Darkness"},
     {"Lord of Darkness", "Lady of Darkness"},

     {"Dark Tyrant", "Dark Tyrant"},
     {"Blackguard Tyrant", "Blackguard Tyrant"},
     {"Evil Despot", "Evil Despot"},
     {"Shadow Tyrant", "Shadow Tyrant"},
     {"Overlord of Shadows", "Overlord of Shadows"},

     {"Blackguard Overlord", "Blackguard Overlord"},
     {"Grand Blackguard", "Grand Blackguard"},
     {"Supreme Evil", "Supreme Evil"},
     {"Eternal Darkness", "Eternal Darkness"},
     {"Master of Darkness", "Mistress of Darkness"},

     {"Blackguard Immortal", "Blackguard Immortal"},
     {"Blackguard Avatar", "Blackguard Avatar"},
     {"Blackguard Deity", "Blackguard Deity"},
     {"Blackguard Supreme", "Blackguard Supreme"},
     {"Darkness Ascendant", "Darkness Ascendant"},

     {"Master Blackguard", "Master Blackguard"},
     {"Master Blackguard", "Master Blackguard"},
     {"Master Blackguard", "Master Blackguard"},
     {"Master Blackguard", "Master Blackguard"},
     {"Master Blackguard", "Master Blackguard"},
     ...
     {"Blackguard Hero", "Blackguard Heroine"},
     {"Avatar of Evil", "Avatar of Evil"},
     {"Angel of Darkness", "Angel of Darkness"},
     {"Demigod of Blackguards", "Demigoddess of Blackguards"},
     {"Immortal Blackguard", "Immortal Blackguard"},
     {"God of Evil", "Goddess of Evil"},
     {"Deity of Chaos", "Deity of Chaos"},
